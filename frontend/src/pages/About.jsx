...
const About = ({ token }) => {
  ...
  const handleScrollToPurpose = () => {
    ...
    document.getElementById("purpose-section").scrollIntoView({ behavior: "smooth" });
  };
  ...
  <div className="flex flex-col md:flex-row items-center">
    ...
    <div className="w-full md:w-3/4 md:pl-6">
      ...
      <p>
        <br />I have a passion for <b>Photography</b> and <b>Web Development</b>,
        and I wanted to create a platform where amateur models and
        photographers can {" "}
        <i
      ...
      <p>
        <br />Here, users can showcase their work, create profiles, and find
        local creators to{" "}
        <i
        ...
        and grow together. No matter you are a professional or a hobbyist, you
        can find the perfect match for your next photoshoot project.
      </p>
    </div>
  </div>
</section>
          ...
          <p className="mb-4">
            <span className="text-red">*</span> PhotoBuddy is still on its <span className="text-red">early stage</span>, so some of the functionalities are still under development. 
            Please reach out to me if you have any comments, I really appreciate it!
            <br />
            <span className="text-red">**</span> I'm also looking for any <span className="text-red">Web/Software Development Job</span> Opportunity. Please let me know if you are willing to give me an interview opportunity
          </p>
          ...
          <div className="collapse collapse-arrow bg-base-200">
            ...
            <div className="collapse-content">
              ...
              <div className="flex flex-wrap justify-center">
                ...
                {/* MongoDB Icon*/}
                <div className="w-1/2 sm:w-1/3 lg:w-1/4 p-2">
                  <img src={mongodb_logo} className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 mx-auto"></img>
          ...
          <div id="purpose-section" className="collapse collapse-arrow bg-base-200">
            ...
            <div className="collapse-content">
              <p className="text-gray-600">
                PhotoBuddy was created with the intention of helping amateur photo creators build their portfolios through collaboration. We believe that everyone should have the opportunity to showcase their talents and grow in their craft, and PhotoBuddy is here to make that possible.
              </p>
            </div>
          </div>
