    ...
    if (contact) {
      user.contact = {
        ...
        phoneNumber_preferred:
          contact.phoneNumber_preferred !== undefined
            ? contact.phoneNumber_preferred
            : user.contact?.phoneNumber_preferred,
        instagram_preferred:
          contact.instagram_preferred !== undefined
            ? contact.instagram_preferred
            : user.contact?.instagram_preferred,
        linkedin_preferred:
          contact.linkedin_preferred !== undefined
            ? contact.linkedin_preferred
            : user.contact?.linkedin_preferred,
        twitter_preferred:
          contact.twitter_preferred !== undefined
            ? contact.twitter_preferred
            : user.contact?.twitter_preferred,
        facebook_preferred:
          contact.facebook_preferred !== undefined
            ? contact.facebook_preferred
            : user.contact?.facebook_preferred,
      };
    }
