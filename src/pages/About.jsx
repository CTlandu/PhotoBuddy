        ...
        <div className="max-w-4xl w-full  shadow-md rounded-lg p-8">
          ...
          <div className="collapse collapse-arrow bg-base-200">
            ...
            <div className="collapse-content">
              ...
              <div className="flex">
                {/* React.js Icon*/}
                <svg xmlns="http://www.w3.org/2000/svg" width="10em" height="10em" viewBox="0 0 256 228" className="mr-5">
                ...
                {/* Tailwindcss Icon*/}
                <svg xmlns="http://www.w3.org/2000/svg" width="10em" height="10em" viewBox="0 0 256 256" className="mr-5">
                  <g fill="none">
                ...
                {/* MongoDB Icon*/}
                <svg xmlns="http://www.w3.org/2000/svg" width="10em" height="10em" viewBox="0 0 128 128">
